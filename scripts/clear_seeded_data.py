...
CLEANUP_EPHEMERAL_STATEMENTS = [
    ...
    "UPDATE vendors SET invited_by = NULL, blacklist_initiated_by = NULL, blacklist_confirmed_by = NULL WHERE org_id NOT IN ('00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000001');",
    ...
    "DELETE FROM user_role_assignments WHERE org_id NOT IN ('00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000001') OR user_id NOT IN (SELECT id FROM users WHERE org_id IN ('00000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000001'));",
