...
TEMPLATES_DATA = [
    ...
    # --- SPEC_27 Indentor Templates ---
    {
        "code": "INDENT_TRANSFERRED",
        "channel": NotificationChannelEnum.EMAIL,
        "subject": "Your Indent {{pr_number}} Has Been Transferred",
        "body": "Hi {{indentor_name}},\n\nYour indent {{pr_number}} titled '{{title}}' has been successfully transferred to {{buyer_name}} in the procurement team.\n\nItems: {{line_count}}\nEstimated Value: {{currency}} {{total_value}}\nNotes: {{indent_notes}}",
        "variables": ["pr_number", "title", "indentor_name", "buyer_name", "line_count", "currency", "total_value", "indent_notes"],
    },
    {
        "code": "INDENT_TRANSFERRED",
        "channel": NotificationChannelEnum.IN_APP,
        "subject": "Indent Transferred",
        "body": "Your indent {{pr_number}} has been transferred to {{buyer_name}}.",
        "variables": ["pr_number", "buyer_name"],
    },
    {
        "code": "INDENT_BUYER_ASSIGNED",
        "channel": NotificationChannelEnum.EMAIL,
        "subject": "New Indent {{pr_number}} Assigned to You",
        "body": "Hi {{buyer_name}},\n\nAn indent has been raised by {{indentor_name}} and assigned to you for processing.\nPR Number: {{pr_number}}\nTitle: {{title}}\nValue: {{currency}} {{total_value}}",
        "variables": ["buyer_name", "indentor_name", "pr_number", "title", "currency", "total_value"],
    },
    {
        "code": "INDENT_BUYER_ASSIGNED",
        "channel": NotificationChannelEnum.IN_APP,
        "subject": "New Indent Assigned",
        "body": "Indent {{pr_number}} was assigned to you by {{indentor_name}}.",
        "variables": ["pr_number", "indentor_name"],
    },
    {
        "code": "INDENT_APPROVED",
        "channel": NotificationChannelEnum.EMAIL,
        "subject": "Your Indent {{pr_number}} Has Been Approved",
        "body": "Hi {{indentor_name}},\n\nYour indent {{pr_number}} titled '{{title}}' has been approved and moved to sourcing.",
        "variables": ["indentor_name", "pr_number", "title"],
    },
    {
        "code": "INDENT_APPROVED",
        "channel": NotificationChannelEnum.IN_APP,
        "subject": "Indent Approved",
        "body": "Indent {{pr_number}} has been approved.",
        "variables": ["pr_number"],
    },
    {
        "code": "INDENT_PO_PLACED",
        "channel": NotificationChannelEnum.EMAIL,
        "subject": "Purchase Order Placed for Your Indent {{pr_number}}",
        "body": "Hi {{indentor_name}},\n\nA Purchase Order ({{po_number}}) has been placed for your indent {{pr_number}}.\nExpected Delivery: {{expected_delivery_date}}",
        "variables": ["indentor_name", "pr_number", "po_number", "expected_delivery_date"],
    },
    {
        "code": "INDENT_PO_PLACED",
        "channel": NotificationChannelEnum.IN_APP,
        "subject": "PO Placed for Indent",
        "body": "PO {{po_number}} placed for Indent {{pr_number}}.",
        "variables": ["po_number", "pr_number"],
    },
    {
        "code": "INDENT_GOODS_DELIVERED",
        "channel": NotificationChannelEnum.EMAIL,
        "subject": "Action Required: Confirm Receipt for Indent {{pr_number}}",
        "body": "Hi {{indentor_name}},\n\nGoods for your indent {{pr_number}} have been delivered (GRN: {{grn_number}}). Please inspect and confirm receipt.",
        "variables": ["indentor_name", "pr_number", "grn_number"],
    },
    {
        "code": "INDENT_GOODS_DELIVERED",
        "channel": NotificationChannelEnum.IN_APP,
        "subject": "Goods Delivered — Confirm Receipt",
        "body": "Goods delivered for Indent {{pr_number}}. Please confirm receipt.",
        "variables": ["pr_number"],
    },
    {
        "code": "INDENT_REJECTED",
        "channel": NotificationChannelEnum.EMAIL,
        "subject": "Your Indent {{pr_number}} Has Been Rejected",
        "body": "Hi {{indentor_name}},\n\nYour indent {{pr_number}} titled '{{title}}' has been rejected.\nReason: {{rejection_reason}}",
        "variables": ["indentor_name", "pr_number", "title", "rejection_reason"],
    },
    {
        "code": "INDENT_REJECTED",
        "channel": NotificationChannelEnum.IN_APP,
        "subject": "Indent Rejected",
        "body": "Indent {{pr_number}} was rejected. Reason: {{rejection_reason}}.",
        "variables": ["pr_number", "rejection_reason"],
    },
]
