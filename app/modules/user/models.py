...
from app.db.enums import USER_STATUS_PG, UserStatusEnum
...
class User(BaseModel):
    ...
    business_unit_id: Mapped[UUID | None] = mapped_column(ForeignKey("business_units.id"), nullable=True)
...
class UserRoleAssignment(Base):
    ...
    assigned_by: Mapped[UUID | None] = mapped_column(ForeignKey("users.id"), nullable=True)
...
class DelegationRule(BaseModel):
    ...
    max_amount_threshold: Mapped[Decimal | None] = mapped_column(Numeric(18, 2), nullable=True)
