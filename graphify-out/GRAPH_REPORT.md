...
## Corpus Check
- 381 files · ~218,642 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3382 nodes · 7401 edges · 274 communities (151 shown, 84 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 314 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f0567450`
...
## Communities (274 total, 84 thin omitted)
...
Cohesion: 0.12
Nodes (28): decode_cursor(), encode_cursor(), paginate_query(), PaginationParams, Any, APIResponse, created_response(), Links (+20 more)
...
Cohesion: 0.05
Nodes (48): get_settings(), Settings, check_idempotency(), Any, Redis, store_idempotency(), UUID, RedisKeys (+40 more)
...
### Community 50 - "tasks"
Cohesion: 0.06
Nodes (27): metadata, metadata, metadata, Providers(), dependsOn, outputs, cache, cache (+19 more)

### Community 51 - "NotFoundError"
Cohesion: 0.11
Nodes (29): AuditAction, ConflictError, NotFoundError, ValidationError, Approval Rules Repository — DB queries for approval rules and versions., Rules Engine Service — find_matching_rule(), detect_conflicts(),…, Master Data Module. Responsibility: Handles operations for Master Data…, DeliveryLocation Service — CRUD operations for delivery locations.… (+21 more)
...
Cohesion: 0.10
Nodes (21): Any, AsyncSession, UUID, CRITICAL: always called WITHIN caller's transaction (never standalone commit).…, InvalidStatusTransitionError, validate_transition(), Any, AsyncSession (+13 more)
...
Cohesion: 0.11
Nodes (40): PermissionCode, CategoryUpdateRequest, create_category(), create_delivery_location(), create_holiday(), delete_category(), get_category_tree(), get_import_status() (+32 more)

### Community 103 - "success_response"
Cohesion: 0.28
Nodes (23): success_response(), amend_requisition(), approve_requisition(), convert_to_po(), convert_to_rfq(), create_requisition(), get_pr_audit_trail(), get_requisition() (+15 more)

### Community 105 - "test_requisition.py"
Cohesion: 0.14
Nodes (32): ProcurementType, PRStatus, InvalidPrTransitionError, PRCreateRequest, PRLineItemRequest, PRSplitItem, PRSplitRequest, create_pr_fixtures() (+24 more)

### Community 106 - "auth/service.py"
Cohesion: 0.07
Nodes (49): get_current_user(), AsyncSession, Request, 7-step auth pipeline: validate token → check user → check session → inactivity., Dependency factory: ensures user has a specific permission., require_permission(), get_db(), get_db_with_rls() (+41 more)
...
Cohesion: 0.09
Nodes (17): hash_password(), load_common_passwords(), mask_pii(), Returns masked value for logging. Never logs raw PII., validate_password_strength(), verify_password(), change_my_password(), ChangePasswordRequest (+9 more)

### Community 129 - "asyncio"
Cohesion: 0.08
Nodes (24): IntegrationJob, CategoryCreateRequest, CategoryRepository, CategoryResponse, CategoryService, Any, AsyncSession, UUID (+16 more)
...
Cohesion: 0.11
Nodes (31): BaseModel, IncotermResponse, PRLineItemResponse, PRListResponse, SourcingPathResult, MappingSuggestionItem, UnmappedPRDashboardResponse, UnmappedPRExceptionResponse (+23 more)

### Community 164 - "config.py"
Cohesion: 0.10
Nodes (17): get_redis_client(), Redis, OutboxPublisher, Requisition, UnmappedPrException, UnmappedPrMappingLog, AsyncSession, UUID (+9 more)

### Community 165 - "encrypt_field"
Cohesion: 0.16
Nodes (13): decrypt_totp_secret(), encrypt_totp_secret(), decrypt_field(), encrypt_field(), get_fernet(), Encrypt a string field. Returns base64-encoded ciphertext string., Decrypt a previously encrypted field., Fernet (+5 more)
...
### Community 167 - "TestUserRouterEndpoints"
Cohesion: 0.22
...
Cohesion: 0.13
Nodes (14): create_mfa_token(), _load_private_key(), _load_public_key(), UUID, Read PEM key from file path., Short-lived token for MFA challenge. Contains NO roles/permissions., _read_key(), SPEC_04 § 5.3 — MFA token cannot authenticate regular endpoints. (+6 more)
...
Cohesion: 0.13
Nodes (23): AppException, AuthenticationError, BusinessRuleError, OptimisticLockError, RateLimitError, Exception, asyncio, Security tests for SPEC_04 — auth security persona tests. CRITICAL: These tests… (+15 more)
...
### Community 225 - "BaseRepository"
Cohesion: 0.11
Nodes (18): BaseRepository, AsyncSession, UUID, Generic repository providing base CRUD and soft delete abstractions., PaymentTermsRepository, AsyncSession, PaymentTerm, UUID (+10 more)
...
Cohesion: 0.10
Nodes (27): Workflow Condition Evaluator — safe expression evaluation using simpleeval.…, ApprovalGroupRepository, AsyncSession, UUID, Approval Group Repository — get group by code, get members., ApprovalGroup, ApprovalGroupMember, WorkflowEvent (+19 more)
...
Cohesion: 0.24
Nodes (5): AuthService, AsyncSession, UUID, Verify TOTP code and mark MFA as enabled., _get_fail_count / _increment_fail_count / _clear_fail_count logic.
...
### Community 236 - "User"
Cohesion: 0.09
Nodes (67): ForbiddenError, User, activate_vendor(), add_bank_account(), add_my_vendor_document(), add_vendor_document(), _assert_vendor_access(), check_duplicates() (+59 more)

### Community 237 - "vendor/service.py"
Cohesion: 0.34
...
### Community 239 - "test_all_models.py"
Cohesion: 0.21
...
### Community 241 - "TestSafeEvalSecurity"
Cohesion: 0.18
...
Cohesion: 0.33
Nodes (7): BusinessUnit, CostCenter, Department, Organization, Plant, setter, test_organization_models()

### Community 243 - "sourcing/models.py"
Cohesion: 0.43
Nodes (7): Rfq, RfqAmendment, RfqClarification, RfqLine, RfqLot, RfqParticipant, test_sourcing_models()

### Community 244 - "ApprovalRuleVersion"
Cohesion: 0.24
...
### Community 247 - "create_refresh_token"
Cohesion: 0.25
...
### Community 252 - "test_grn_and_invoice_models"
Cohesion: 0.29
...
### Community 258 - "async_check_compliance"
Cohesion: 0.33
...
## Knowledge Gaps
- **512 isolated node(s):** `entrypoint.sh script`, `RequisitionLineItem`, `PRLineItemTableProps`, `metadata`, `nextConfig` (+507 more)
...
- **Why does `BaseModel` connect `BaseModel` to `evaluation/models.py`, `asyncio`, `TaxService`, `schemas.py`, `test_vendor.py`, `Base`, `config.py`, `DeliveryLocationService`, `unmapped_pr/router.py`, `test_master_data_router.py`, `contract/models.py`, `RedisKeys`, `holiday/service.py`, `NotFoundError`, `RequisitionService`, `approval_rules/router.py`, `BaseRepository`, `PermissionCode`, `ErpMappingService`, `workflow/service.py`, `success_response`, `test_requisition.py`, `auth/service.py`, `User`, `validate_password_strength`, `vendor/service.py`, `test_all_models.py`, `auth/router.py`, `workflow/router.py`, `organization/models.py`, `sourcing/models.py`, `ApprovalRuleVersion`, `test_grn_and_invoice_models`, `ApprovalRule`, `bid/models.py`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `PermissionCode`, `BaseModel`, `workflow/service.py`, `AuthService`, `success_response`, `auth/service.py`, `unmapped_pr/router.py`, `workflow/router.py`, `WorkflowEngine`, `test_master_data_router.py`, `auth/router.py`, `SessionRepository`, `NotFoundError`, `RequisitionService`, `test_vendor.py`, `approval_rules/router.py`, `test_auth_coverage.py`, `validate_password_strength`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `AppException` connect `AppException` to `test_vendor.py`, `config.py`, `test_pr_workflows.py`, `NotFoundError`, `test_workflow_engine.py`, `.publish`, `LoginResult`, `SessionRepository`, `.__init__`, `RequisitionService`, `test_auth_coverage.py`, `workflow/service.py`, `AuthService`, `test_requisition.py`, `auth/service.py`, `User`, `vendor/service.py`, `WorkflowEngine`, `auth/router.py`, `validate_password_strength`?**
