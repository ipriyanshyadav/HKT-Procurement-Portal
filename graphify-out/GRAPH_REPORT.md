...
## Summary
- 3648 nodes · 7923 edges · 296 communities (176 shown, 77 thin omitted)
...
Cohesion: 0.08
Nodes (37): RequisitionDetailPage(), NewRequisitionPage(), RequisitionsListPage(), UnmappedPRsDashboardPage(), useUoms(), APIResponse, BusinessUnit, CostCenter (+29 more)
...
### Community 44 - "organization/router.py"
Cohesion: 0.26
...
### Community 51 - "test_master_data.py"
Cohesion: 0.14
...
Cohesion: 0.12
Nodes (18): AdminMainLayout(), MFAForm, mfaSchema, BuyerMainLayout(), SupplierMainLayout(), CurrentUser, LoginPayload, LoginResponse (+10 more)
...
Cohesion: 0.16
Nodes (13): get_settings(), Settings, BaseSettings, Master data seed script. Seeds ALL permissions (100+), ALL 15 roles (REQUESTOR…, seed_data(), env_setup(), fixture, test_all_celery_intervals_accessible() (+5 more)
...
Cohesion: 0.12
Nodes (13): hash_password(), load_common_passwords(), validate_password_strength(), verify_password(), change_my_password(), ChangePasswordRequest, PUT /api/v1/users/me/password — change own password., Unit tests for app.core.security — password hashing, validation, PII masking.… (+5 more)
...
### Community 95 - "test_auth_coverage.py"
Cohesion: 0.10
Nodes (15): LoginResult, SSOResult, AsyncSession, UUID, user_has_permission(), asyncio, Additional coverage tests for auth service, dependencies, MFA, repository…, AuditService.log() never commits — that's the caller's responsibility. (+7 more)
...
### Community 98 - "success_response"
Cohesion: 0.11
Nodes (43): PermissionCode, success_response(), CategoryUpdateRequest, PaymentTermResponse, create_category(), create_delivery_location(), create_holiday(), delete_category() (+35 more)

### Community 100 - "get_redis_client"
Cohesion: 0.14
Nodes (9): get_redis_client(), Redis, _async_refresh(), task, Daily Celery task to fetch latest exchange rates and update cache + DB., Fetch daily exchange rates; cache in Redis and persist to DB., refresh_exchange_rates(), Any (+1 more)
...
Cohesion: 0.10
Nodes (43): ProcurementType, PRStatus, InvalidPrTransitionError, BudgetCheckResult, PRCreateRequest, PRLineItemRequest, PRLineItemResponse, PRMergeRequest (+35 more)

### Community 106 - "create_user"
Cohesion: 0.11
Nodes (23): activate_user(), create_user(), deactivate_user(), get_me(), get_my_permissions(), get_user(), list_users(), AsyncSession (+15 more)

### Community 107 - "vendor/service.py"
Cohesion: 0.07
Nodes (48): Integration Adapters Module. Responsibility: Handles operations for Integration…, Vendor, VendorBankAccount, VendorCategoryMapping, VendorContact, VendorDocument, VendorErpSyncLog, VendorScorecard (+40 more)
...
Cohesion: 0.10
Nodes (34): confirm_mfa(), enroll_mfa(), login(), logout(), oidc_callback(), AsyncSession, get, post (+26 more)

### Community 126 - "devDependencies"
Cohesion: 0.12
Nodes (17): devDependencies, autoprefixer, postcss, @procurement/config, tailwindcss, @types/node, @types/react, @types/react-dom (+9 more)

### Community 127 - "mask_pii"
Cohesion: 0.39
Nodes (3): mask_pii(), Returns masked value for logging. Never logs raw PII., TestMaskPII

### Community 129 - "asyncio"
Cohesion: 0.12
Nodes (16): CategoryCreateRequest, CategoryRepository, CategoryResponse, CategoryService, Any, AsyncSession, UUID, Returns full category tree or subtree using recursive CTE. (+8 more)
...
Cohesion: 0.12
Nodes (23): OutboxPublisher, UUID, Workflow Events — all 10 RabbitMQ event routing keys published via outbox…, async_check_pr_aging(), check_pr_aging(), Any, task, async_check_unmapped_sla() (+15 more)

### Community 161 - "Base"
Cohesion: 0.13
Nodes (21): Base, Database definitions., Document, DocumentVersion, FeatureFlag, OutboxMessage, ScheduledJobRun, TenantSetting (+13 more)
...
Cohesion: 0.26
Nodes (8): Requisition, UnmappedPrException, UnmappedPrMappingLog, datetime, AsyncSession, UUID, UnmappedPrRepository, test_requisition_models()
...
### Community 166 - "AuditAction"
Cohesion: 0.07
Nodes (30): AuditAction, DeliveryLocationRepository, DeliveryLocationService, LocationCreateRequest, LocationResponse, LocationUpdateRequest, AsyncSession, field_validator (+22 more)
...
### Community 173 - "test_master_data_router.py"
Cohesion: 0.11
...
Cohesion: 0.18
Nodes (16): UUID, RedisKeys, test_bid_seal(), test_exchange_rate_key(), test_failed_login_key(), test_idempotency_key(), test_notification_channel_key(), test_pending_approvals_key() (+8 more)
...
### Community 178 - "AuthenticationError"
Cohesion: 0.16
Nodes (10): AuthService, AsyncSession, UUID, Generate TOTP secret and return URI for QR code. Not enabled until confirm_mfa., Verify TOTP code and mark MFA as enabled., AuthenticationError, SPEC_04 § 5 — Refresh token rotation: reuse of old token revokes all sessions., When a revoked token is reused, all sessions must be revoked. (+2 more)

### Community 179 - "decode_jwt"
Cohesion: 0.07
Nodes (29): create_access_token(), create_mfa_token(), create_refresh_token(), decode_jwt(), _load_private_key(), _load_public_key(), UUID, Read PEM key from file path. (+21 more)
...
Cohesion: 0.10
Nodes (25): AppException, BusinessRuleError, ConflictError, OptimisticLockError, Any, RateLimitError, InvalidStatusTransitionError, Exception (+17 more)

### Community 210 - "audit/service.py"
Cohesion: 0.27
Nodes (7): AuditLog, AuditService, Any, AsyncSession, UUID, INSERT-ONLY audit service. Never UPDATE or DELETE., Insert an audit log entry. Caller's transaction commits it.
...
Cohesion: 0.04
Nodes (62): AdminDashboardPage(), CategoryNode, BudgetIndicator(), BudgetIndicatorProps, AppShellProps, Badge(), BadgeProps, BadgeVariant (+54 more)
...
Cohesion: 0.18
Nodes (10): ValidationError, IntegrationJob, MasterDataImportService, AsyncSession, UUID, _async_import(), import_categories_task(), task (+2 more)
...
### Community 224 - "evaluation/models.py"
Cohesion: 0.39
...
### Community 225 - "created_response"
Cohesion: 0.16
...
### Community 230 - "contract/models.py"
Cohesion: 0.43
...
### Community 232 - "UnmappedPRService"
Cohesion: 0.49
Nodes (4): AsyncSession, Requisition, UUID, UnmappedPRService

### Community 233 - "test_auth_security.py"
Cohesion: 0.08
Nodes (26): decrypt_totp_secret(), encrypt_totp_secret(), generate_backup_codes(), generate_totp_secret(), get_totp_uri(), Generate a new TOTP secret (base32)., Return otpauth:// URI for QR code display., Verify TOTP code. Allows 1 step drift. (+18 more)

### Community 234 - "workflow/service.py"
Cohesion: 0.22
Nodes (12): AsyncSession, UUID, Approval Group Repository — get group by code, get members., ApprovalGroup, ApprovalGroupMember, WorkflowEvent, WorkflowInstance, WorkflowTask (+4 more)
...
Cohesion: 0.06
Nodes (91): ForbiddenError, BaseModel, activate_vendor(), add_bank_account(), add_my_vendor_document(), add_vendor_document(), _assert_vendor_access(), check_duplicates() (+83 more)

### Community 237 - "idempotency.py"
Cohesion: 0.53
Nodes (4): check_idempotency(), Any, Redis, store_idempotency()
...
### Community 241 - "TestSLAStatusThresholds"
Cohesion: 0.50
...
Cohesion: 0.09
Nodes (28): BusinessUnit, CostCenter, Department, LegalEntity, Organization, Plant, setter, BusinessUnitRepository (+20 more)
...
### Community 252 - "unmapped_pr/router.py"
Cohesion: 0.14
Nodes (22): get_current_user(), AsyncSession, Request, 7-step auth pipeline: validate token → check user → check session → inactivity., PRDetailResponse, PRListResponse, auto_map_pr(), get_mapping_suggestions() (+14 more)
...
### Community 260 - "TestPermanentlyDeniedPermissions"
Cohesion: 0.25
Nodes (5): SPEC_04 § 10.1 — rfq.view_bids_before_opening is PERMANENTLY denied., This permission must be in PERMANENTLY_DENIED_PERMISSIONS regardless of role., The denied set should contain the critical permission., Even PROCUREMENT_ADMIN cannot have rfq.view_bids_before_opening., TestPermanentlyDeniedPermissions
...
### Community 262 - "User"
Cohesion: 0.32
Nodes (21): amend_requisition(), approve_requisition(), convert_to_po(), convert_to_rfq(), create_requisition(), get_pr_audit_trail(), get_requisition(), list_requisitions() (+13 more)
...
### Community 271 - "user/models.py"
Cohesion: 0.20
Nodes (16): Dependency factory: ensures user has a specific permission., require_permission(), DelegationRule, PasswordHistory, Permission, Role, RolePermission, UserBuScope (+8 more)
...
### Community 273 - "test_all_models.py"
Cohesion: 0.16
Nodes (17): BidDocument, BidLineResponse, BidResponse, BidVersion, PoAmendment, PoLine, PurchaseOrder, Rfq (+9 more)
...
## Knowledge Gaps
- **599 isolated node(s):** `entrypoint.sh script`, `CategoryNode`, `metadata`, `PUBLIC_ROUTES`, `AUTH_GROUP_ROUTES` (+594 more)
...
- **Why does `BaseModel` connect `BaseModel` to `asyncio`, `User`, `schemas.py`, `user/models.py`, `test_all_models.py`, `currency/service.py`, `Base`, `unmapped_pr/service.py`, `AuditAction`, `organization/router.py`, `test_master_data_router.py`, `holiday/service.py`, `test_master_data.py`, `tax/service.py`, `audit/service.py`, `RequisitionService`, `approval_rules/router.py`, `validate_password_strength`, `approval_rules/service.py`, `grn/models.py`, `ValidationError`, `evaluation/models.py`, `created_response`, `ApprovalRule`, `success_response`, `erp_mapping/service.py`, `contract/models.py`, `requisition/service.py`, `create_user`, `vendor/service.py`, `workflow/service.py`, `workflow/router.py`, `auth/router.py`, `seed_demo_user.py`, `unmapped_pr/router.py`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `user/models.py`, `UserRepository`, `organization/router.py`, `test_master_data_router.py`, `AuthenticationError`, `RequisitionService`, `approval_rules/router.py`, `validate_password_strength`, `test_repositories.py`, `test_auth_coverage.py`, `success_response`, `requisition/service.py`, `create_user`, `workflow/service.py`, `BaseModel`, `workflow/router.py`, `WorkflowEngine`, `ApproverResolver`, `auth/router.py`, `vendor/service.py`, `seed_demo_user.py`, `session.py`, `unmapped_pr/router.py`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `AppException` connect `AppException` to `user/models.py`, `test_pr_workflows.py`, `unmapped_pr/service.py`, `AuthenticationError`, `test_workflow_engine.py`, `NotFoundError`, `RequisitionService`, `validate_password_strength`, `approval_rules/service.py`, `ValidationError`, `test_auth_coverage.py`, `test_vendor_workflows.py`, `UnmappedPRService`, `requisition/service.py`, `create_user`, `vendor/service.py`, `BaseModel`, `workflow/service.py`, `WorkflowEngine`, `ApproverResolver`, `auth/router.py`, `test_auth_security.py`?**
