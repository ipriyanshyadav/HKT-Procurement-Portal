...
## Corpus Check
- 421 files · ~253,204 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3659 nodes · 7976 edges · 306 communities (175 shown, 88 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 318 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7d1a89d1`
...
1. `BaseModel` - 196 edges
2. `User` - 138 edges
3. `success_response()` - 84 edges
4. `AppException` - 83 edges
5. `NotFoundError` - 77 edges
6. `PermissionCode` - 64 edges
7. `ConflictError` - 54 edges
8. `ForbiddenError` - 54 edges
9. `ValidationError` - 49 edges
10. `RedisKeys` - 49 edges
...
## Communities (306 total, 88 thin omitted)
...
Cohesion: 0.09
Nodes (34): RequisitionDetailPage(), NewRequisitionPage(), RequisitionsListPage(), UnmappedPRsDashboardPage(), useUoms(), useBusinessUnits(), useCostCenters(), CreateRequisitionPayload (+26 more)
...
### Community 24 - "currency/service.py"
Cohesion: 0.18
Nodes (10): CurrencyCreateRequest, CurrencyRepository, CurrencyResponse, CurrencyService, CurrencyUpdateRequest, AsyncSession, UUID, Persist rate to database and cache in Redis. (+2 more)
...
### Community 44 - "get_current_user"
Cohesion: 0.16
Nodes (15): get_current_user(), AsyncSession, Request, 7-step auth pipeline: validate token → check user → check session → inactivity., health(), list_business_units(), list_cost_centers(), AsyncSession (+7 more)
...
### Community 50 - "tasks"
Cohesion: 0.11
Nodes (19): dependsOn, cache, cache, persistent, cache, globalDependencies, $schema, tasks (+11 more)

### Community 51 - "payment_terms/service.py"
Cohesion: 0.13
Nodes (18): PaymentTermCreateRequest, PaymentTermResponse, PaymentTermUpdateRequest, PaymentTermsService, AsyncSession, Decimal, PaymentTerm, UUID (+10 more)
...
Cohesion: 0.07
Nodes (29): dependencies, lucide-react, devDependencies, autoprefixer, postcss, tailwindcss, tsx, turbo (+21 more)
...
Cohesion: 0.42
Nodes (9): LoggingContextMiddleware, RequestIDMiddleware, SecurityHeadersMiddleware, TimingMiddleware, setup_telemetry(), create_app(), lifespan(), FastAPI (+1 more)
...
### Community 75 - "tax/service.py"
Cohesion: 0.07
Nodes (29): AsyncSession, Decimal, field_validator, model_validator, UUID, TaxService — GST HSN/SAC codes and TDS management. Allowed tax types: GST,…, Serialisable representation of a TaxCode record., Data-access layer for TaxCode entities. (+21 more)

### Community 76 - "useAuth.ts"
Cohesion: 0.10
Nodes (21): AdminMainLayout(), MFAForm, mfaSchema, BuyerMainLayout(), SupplierMainLayout(), CurrentUser, LoginPayload, LoginResponse (+13 more)
...
### Community 87 - "TestAuthLoginEndpoint"
Cohesion: 0.17
...
### Community 88 - "organization/service.py"
Cohesion: 0.16
Nodes (11): BusinessUnitRepository, CostCenterRepository, AsyncSession, BusinessUnit, CostCenter, UUID, OrganizationService, AsyncSession (+3 more)

### Community 89 - "approval_rules/router.py"
Cohesion: 0.13
Nodes (27): activate_rule(), create_rule(), deactivate_rule(), get_rule_versions(), list_rules(), AsyncSession, get, post (+19 more)

### Community 90 - "validate_password_strength"
Cohesion: 0.22
...
### Community 91 - "approval_rules/service.py"
Cohesion: 0.23
Nodes (7): ApprovalRuleVersion, datetime, UUID, Approval Rules Models — ApprovalRule + ApprovalRuleVersion. Matches PostgreSQL…, Immutable snapshot of an approval rule at activation time. Created on…, Approval Rules Repository — DB queries for approval rules and versions., Rules Engine Service — find_matching_rule(), detect_conflicts(),…

### Community 92 - "RulesEngine"
Cohesion: 0.16
Nodes (13): Any, AsyncSession, UUID, Activate a rule. Blocks if priority conflicts exist. Creates an immutable…, Deactivate a rule. Does NOT create a version snapshot (A-06-3)., Approval Rules matching engine. Immutable rule evaluation: reads active rules,…, Evaluate all active rules for entity_type in priority order (ascending = higher…, Detect priority conflicts: two active rules with same entity_type and priority.… (+5 more)

### Community 94 - "test_repositories.py"
Cohesion: 0.13
...
Cohesion: 0.10
Nodes (42): PermissionCode, create_category(), create_delivery_location(), create_holiday(), delete_category(), get_category_tree(), get_import_status(), health() (+34 more)

### Community 100 - "GSTAdapter"
Cohesion: 0.16
Nodes (6): Integration Adapters Module. Responsibility: Handles operations for Integration…, GSTAdapter, Any, PANAdapter, Any, test_vendor_verify_key()

### Community 101 - "seed_workflows.py"
Cohesion: 0.36
Nodes (8): main(), AsyncSession, UUID, Workflow Template Seed Script — inserts all 10 workflow template definitions.…, Insert all workflow templates. Idempotent on (code, org_id)., Insert catch-all PR approval rule. Idempotent via ORM query., seed_catch_all_rule(), seed_workflows()
...
### Community 103 - "VendorRepository"
Cohesion: 0.18
Nodes (9): AsyncSession, date, UUID, Vendor, VendorBankAccount, VendorDocument, VendorScorecard, VendorRepository (+1 more)

### Community 104 - "cn"
Cohesion: 0.16
Nodes (14): CategoryTreeNode, CategoryTreeSelect(), CategoryTreeSelectProps, findNodeById(), CurrencyOption, CurrencySelect(), CurrencySelectProps, PaymentTermOption (+6 more)

### Community 105 - "requisition/service.py"
Cohesion: 0.11
Nodes (39): ProcurementType, BudgetCheckResult, PRCreateRequest, PRLineItemRequest, PRLineItemResponse, PRMergeRequest, PRSplitItem, PRSplitRequest (+31 more)

### Community 106 - "user/router.py"
Cohesion: 0.12
Nodes (27): activate_user(), change_my_password(), ChangePasswordRequest, create_user(), deactivate_user(), get_me(), get_my_permissions(), get_user() (+19 more)

### Community 107 - "vendor/service.py"
Cohesion: 0.08
Nodes (48): Vendor, VendorBankAccount, VendorCategoryMapping, VendorContact, VendorDocument, VendorErpSyncLog, VendorScorecard, DuplicateCheckResult (+40 more)

### Community 108 - "workflow/router.py"
Cohesion: 0.11
Nodes (36): approve_task(), cancel_instance(), force_advance(), get_instance(), get_my_tasks(), pause_instance(), AsyncSession, get (+28 more)
...
### Community 127 - "hash_password"
Cohesion: 0.17
Nodes (9): hash_password(), load_common_passwords(), mask_pii(), Returns masked value for logging. Never logs raw PII., verify_password(), Unit tests for app.core.security — password hashing, validation, PII masking.…, bcrypt is salted — same password produces different hashes., TestMaskPII (+1 more)

### Community 129 - "asyncio"
Cohesion: 0.11
Nodes (20): CategoryCreateRequest, CategoryRepository, CategoryResponse, CategoryService, CategoryUpdateRequest, Any, AsyncSession, UUID (+12 more)

### Community 131 - "admin-portal/middleware.ts"
Cohesion: 0.40
Nodes (3): AUTH_GROUP_ROUTES, config, PUBLIC_ROUTES

### Community 154 - "test_pr_workflows.py"
Cohesion: 0.11
Nodes (26): PRStatus, OutboxPublisher, async_check_pr_aging(), check_pr_aging(), Any, task, async_check_unmapped_sla(), check_unmapped_pr_sla() (+18 more)

### Community 161 - "BaseModel"
Cohesion: 0.07
Nodes (57): Base, BaseModel, Database definitions., AuditLog, BidDocument, BidLineResponse, BidResponse, BidVersion (+49 more)

### Community 162 - "enums.py"
Cohesion: 0.12
Nodes (26): ConflictError, ApprovalTaskStatus, AuditEntityType, BidStatus, ContractStatus, DocumentCategory, EvaluationType, IntegrationJobStatus (+18 more)

### Community 163 - ".publish"
Cohesion: 0.22
...
### Community 164 - "unmapped_pr/service.py"
Cohesion: 0.28
...
### Community 165 - "ApprovalRulesRepository"
Cohesion: 0.23
Nodes (7): ApprovalRulesRepository, AsyncSession, datetime, UUID, Returns all active rules for entity_type and org_id that are within the…, Find rules with same entity_type and priority (conflict detection)., Return all version snapshots for a rule, newest first.

### Community 166 - "DeliveryLocationRepository"
Cohesion: 0.13
Nodes (16): DeliveryLocationRepository, AsyncSession, UUID, Thin async data-access layer for DeliveryLocation. All queries are scoped to…, Fetch one location by PK + org scope. Raises NotFoundError if absent., Return a location matching *code* within the org, optionally excluding a row id., Return all delivery locations for an org, with optional active/country filters., Persist a new DeliveryLocation. Caller must commit. (+8 more)

### Community 167 - "UserRepository"
Cohesion: 0.24
Nodes (4): AsyncSession, UUID, UserRepository, TestUserRepository
...
Cohesion: 0.10
Nodes (24): AsyncSession, model_validator, UUID, Return all non-deleted UoM records for *org_id*. When *include_inactive* is…, Fetch a non-deleted UoM by primary key and org scope. Raises…, Business-logic layer for Unit of Measure master data. Follows the router ->…, Return all UoM records visible to *org_id*. Args: db: Active async database…, Fetch a single UoM by primary key within *org_id*. Args: db: Active async… (+16 more)

### Community 170 - "hooks/src/index.ts"
Cohesion: 0.09
Nodes (41): CategoryDetailPage(), findNodeAndAncestors(), CategoriesPage(), MasterDataImportPage(), InviteVendorPage(), SimulateApprover, SimulateChainStep, SimulateRequest (+33 more)
...
### Community 173 - "test_master_data.py"
Cohesion: 0.10
Nodes (28): HolidayService — manages organisational and plant-level holiday calendars.…, Category, CurrencyMaster, DeliveryLocation, DocumentType, HolidayMaster, Incoterm, PaymentTerm (+20 more)
...
### Community 175 - "RedisKeys"
Cohesion: 0.15
Nodes (18): check_idempotency(), Any, Redis, store_idempotency(), UUID, RedisKeys, test_bid_seal(), test_failed_login_key() (+10 more)
...
### Community 179 - "decode_jwt"
Cohesion: 0.10
Nodes (19): create_access_token(), create_refresh_token(), decode_jwt(), _load_private_key(), _load_public_key(), UUID, Read PEM key from file path., Decode and verify a JWT. Raises AuthenticationError on failure. (+11 more)
...
### Community 208 - "SessionRepository"
Cohesion: 0.21
Nodes (6): AsyncSession, datetime, UUID, SessionRepository, asyncio, TestSessionRepository

### Community 209 - "AppException"
Cohesion: 0.17
Nodes (16): AppException, AuthenticationError, BusinessRuleError, OptimisticLockError, Any, RateLimitError, Exception, test_app_exception() (+8 more)
...
### Community 212 - "create_mfa_token"
Cohesion: 0.15
...
Cohesion: 0.04
Nodes (75): AdminDashboardPage(), CategoryNode, BudgetIndicator(), BudgetIndicatorProps, AppShellProps, Badge(), BadgeProps, BadgeVariant (+67 more)

### Community 214 - "WorkflowRepository"
Cohesion: 0.28
...
### Community 216 - "PaymentTermsRepository"
Cohesion: 0.24
...
### Community 221 - ".exchange_rate"
Cohesion: 0.20
Nodes (8): Decimal, Fetch cached exchange rate from Redis., _async_refresh(), task, Daily Celery task to fetch latest exchange rates and update cache + DB., Fetch daily exchange rates; cache in Redis and persist to DB., refresh_exchange_rates(), test_exchange_rate_key()

### Community 222 - "ValidationError"
Cohesion: 0.09
Nodes (21): AuditAction, ValidationError, IntegrationJob, MasterDataImportService, AsyncSession, UUID, Master Data Module. Responsibility: Handles operations for Master Data…, DeliveryLocationService (+13 more)

### Community 223 - "test_vendor_workflows.py"
Cohesion: 0.11
Nodes (22): ApprovalTaskStatusEnum, build_engine(), make_task(), make_user(), asyncio, UUID, Workflow tests for Vendor Management (SPEC_07). Tests cover: 1. VENDOR_QUAL…, Tests for VENDOR_QUAL qualification workflow. (+14 more)

### Community 224 - "BankVerificationAdapter"
Cohesion: 0.33
Nodes (3): BankVerificationAdapter, Any, UUID

### Community 225 - "pagination.py"
Cohesion: 0.35
Nodes (9): decode_cursor(), encode_cursor(), paginate_query(), PaginationParams, Any, Links, test_cursor_encoding_decoding(), test_decode_cursor_empty() (+1 more)

### Community 226 - "erp_mapping/service.py"
Cohesion: 0.23
...
### Community 227 - "[taskId]/page.tsx"
Cohesion: 0.10
Nodes (23): TasksPage(), ActionType, TaskDetailPage(), TaskActionPayload, TaskListResponse, useApproveTask(), useMyWorkflowTasks(), useRejectTask() (+15 more)

### Community 228 - "useLogin"
Cohesion: 0.24
Nodes (8): AdminLoginPage(), LoginForm, LoginPage(), loginSchema, LoginForm, loginSchema, SupplierLoginPage(), useLogin()
...
### Community 230 - "TestSafeEvalSecurity"
Cohesion: 0.18
...
### Community 232 - "unmapped_pr/schemas.py"
Cohesion: 0.21
Nodes (10): PRListResponse, MappingSuggestionItem, UnmappedPRDashboardResponse, UnmappedPRExceptionResponse, UnmappedPRMappingItem, UnmappedPRSuggestionResponse, AsyncSession, Requisition (+2 more)

### Community 233 - "test_auth_security.py"
Cohesion: 0.09
Nodes (25): decrypt_totp_secret(), encrypt_totp_secret(), generate_backup_codes(), generate_totp_secret(), get_totp_uri(), Generate a new TOTP secret (base32)., Return otpauth:// URI for QR code display., Verify TOTP code. Allows 1 step drift. (+17 more)

### Community 234 - "workflow/service.py"
Cohesion: 0.16
Nodes (16): ApprovalGroupRepository, AsyncSession, UUID, Approval Group Repository — get group by code, get members., ApprovalGroup, ApprovalGroupMember, WorkflowEvent, WorkflowInstance (+8 more)
...
### Community 236 - "vendor/router.py"
Cohesion: 0.06
Nodes (84): ForbiddenError, activate_vendor(), add_bank_account(), add_my_vendor_document(), add_vendor_document(), _assert_vendor_access(), check_duplicates(), confirm_blacklist() (+76 more)

### Community 237 - "HolidayRepository"
Cohesion: 0.42
Nodes (5): HolidayRepository, AsyncSession, date, HolidayMaster, UUID

### Community 238 - "useVendors.ts"
Cohesion: 0.07
Nodes (45): VendorDetailPage(), VendorsListPage(), DOCUMENT_TYPES, generateUuid(), SupplierDocumentsPage(), SupplierProfilePage(), SupplierRegistrationWizard(), WIZARD_STEPS (+37 more)

### Community 239 - "._by_role"
Cohesion: 0.29
...
### Community 240 - "TestUserRouterEndpoints"
Cohesion: 0.22
...
### Community 242 - "seed_demo_user.py"
Cohesion: 0.14
Nodes (22): BusinessUnit, CostCenter, Department, LegalEntity, Organization, Plant, setter, Demo user and sample data seed script for the default organization. Seeds: -… (+14 more)
...
### Community 246 - "session.py"
Cohesion: 0.18
Nodes (9): get_db(), get_db_with_rls(), AsyncSession, UUID, _fake_db(), Auth router integration tests using FastAPI TestClient. Tests the HTTP layer of…, Test Pydantic schema validation via HTTP., Override get_db with a mock async generator. (+1 more)

### Community 247 - "TestSecurityHeaders"
Cohesion: 0.40
Nodes (3): Security headers middleware should add CSP header., GEMINI.md: No magic numbers in logic., TestSecurityHeaders

### Community 252 - "success_response"
Cohesion: 0.18
Nodes (20): APIResponse, created_response(), PaginationMeta, Any, success_response(), PRDetailResponse, auto_map_pr(), get_mapping_suggestions() (+12 more)

### Community 253 - "sla_timers.py"
Cohesion: 0.24
Nodes (11): _async_check_sla(), check_workflow_sla_timers(), _evaluate_task_sla(), datetime, task, WorkflowTask, SLA Timer Celery Task — checks all pending workflow tasks against SLA…, Reassign a timed-out task to the procurement admin escalation chain. (+3 more)
...
### Community 260 - "require_permission"
Cohesion: 0.09
Nodes (17): Dependency factory: ensures user has a specific permission., require_permission(), asyncio, SPEC_04 § 6 — brute-force lockout after 5 failed attempts., Incrementing fail count and checking against limit., Locked account raises AppException with ACCOUNT_LOCKED code., Simulates 5 failure increments then lockout check., SPEC_04 § 5 — Refresh token rotation: reuse of old token revokes all sessions. (+9 more)
...
### Community 262 - "User"
Cohesion: 0.27
Nodes (22): amend_requisition(), approve_requisition(), convert_to_po(), convert_to_rfq(), create_requisition(), get_pr_audit_trail(), get_requisition(), list_requisitions() (+14 more)
...
### Community 271 - "BaseRepository"
Cohesion: 0.17
Nodes (17): BaseRepository, AsyncSession, UUID, Generic repository providing base CRUD and soft delete abstractions., DelegationRule, PasswordHistory, Permission, Role (+9 more)
...
### Community 273 - "sourcing/models.py"
Cohesion: 0.43
...
## Knowledge Gaps
- **600 isolated node(s):** `entrypoint.sh script`, `CategoryNode`, `metadata`, `PUBLIC_ROUTES`, `AUTH_GROUP_ROUTES` (+595 more)
...
- **Why does `BaseModel` connect `BaseModel` to `asyncio`, `User`, `schemas.py`, `BaseRepository`, `sourcing/models.py`, `currency/service.py`, `unmapped_pr/service.py`, `get_current_user`, `test_master_data.py`, `HolidayService`, `payment_terms/service.py`, `tax/service.py`, `RequisitionService`, `approval_rules/router.py`, `approval_rules/service.py`, `ValidationError`, `pagination.py`, `ApprovalRule`, `erp_mapping/service.py`, `PermissionCode`, `unmapped_pr/schemas.py`, `requisition/service.py`, `user/router.py`, `vendor/service.py`, `vendor/router.py`, `workflow/service.py`, `workflow/router.py`, `auth/router.py`, `seed_demo_user.py`, `success_response`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `BaseRepository`, `test_auth_security.py`, `BaseModel`, `UserRepository`, `get_current_user`, `test_master_data.py`, `AuthService`, `AppException`, `RequisitionService`, `approval_rules/router.py`, `test_repositories.py`, `PermissionCode`, `requisition/service.py`, `user/router.py`, `workflow/service.py`, `vendor/router.py`, `workflow/router.py`, `WorkflowEngine`, `._by_role`, `auth/router.py`, `vendor/service.py`, `seed_demo_user.py`, `session.py`, `success_response`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `AppException` connect `AppException` to `require_permission`, `BaseRepository`, `test_pr_workflows.py`, `enums.py`, `unmapped_pr/service.py`, `AuthService`, `test_workflow_engine.py`, `NotFoundError`, `RequisitionService`, `approval_rules/service.py`, `ValidationError`, `LoginResult`, `test_vendor_workflows.py`, `unmapped_pr/schemas.py`, `requisition/service.py`, `user/router.py`, `vendor/service.py`, `vendor/router.py`, `workflow/service.py`, `WorkflowEngine`, `._by_role`, `auth/router.py`, `test_auth_security.py`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Are the 32 inferred relationships involving `AppException` (e.g. with `refresh()` and `sso_callback()`) actually correct?**
  _`AppException` has 32 INFERRED edges - model-reasoned connections that need verification._
- **Are the 14 inferred relationships involving `NotFoundError` (e.g. with `BaseRepository` and `ErpMappingService`) actually correct?**
  _`NotFoundError` has 14 INFERRED edges - model-reasoned connections that need verification._
- **What connects `entrypoint.sh script`, `CategoryNode`, `metadata` to the rest of the system?**
