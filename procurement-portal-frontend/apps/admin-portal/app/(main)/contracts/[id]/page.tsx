...
export default function ContractWorkspacePage() {
  ...
  if (isError || !contract) {
    return (
      <div className="p-20 text-center text-red-500 space-y-4">
        <AlertTriangle className="w-8 h-8 mx-auto text-red-500" />
        <p className="text-sm font-medium">Failed to load contract details. Please verify the ID or your permissions.</p>
        <div>
          <Link
            href="/contracts"
            className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-medium rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors"
          >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-4">
        <div>
          <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 mb-1">
            <Link href="/contracts" className="hover:underline inline-flex items-center gap-1 font-medium text-blue-600 dark:text-blue-400">
