              ...
              <li key={task.id} className={`transition-colors ${isSelected ? "bg-indigo-50/40 dark:bg-indigo-950/20" : "hover:bg-gray-50 dark:hover:bg-slate-800/50"}`}>
                <div className="flex items-start gap-3 p-4">
                  ...
                  <div className="flex-1 flex items-start gap-4 min-w-0">
                        ...
                        {task.entity_number && (
                          entityUrl ? (
                            <Link
                              ...
                              className="font-mono text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:underline bg-indigo-50 dark:bg-indigo-950/40 px-2 py-0.5 rounded border border-indigo-200 dark:border-indigo-800"
                            >
                              {task.entity_number}
                            </Link>
                          ) : (
                      ...
                      <div className="flex items-center gap-4 mt-2 text-xs text-slate-500 dark:text-slate-400 flex-wrap">
                        {task.raised_by_name && (
                          <span className="flex items-center gap-1.5">
                            ...
                            {task.raised_by_email && (
                              <span className="text-[11px] text-slate-400">({task.raised_by_email})</span>
                            )}
                          </span>
                        )}
                        ...
                        {task.department && (
                          <span className="flex items-center gap-1">
                            ...
                            <span className="font-medium text-slate-700 dark:text-slate-300">{task.department}</span>
                          </span>
                        )}
                    ...
                    <Link
                      href={`/tasks/${task.id}`}
                      className="flex-shrink-0 flex items-center self-center text-gray-400 hover:text-indigo-600 text-sm pr-2"
